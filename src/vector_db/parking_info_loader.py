...
def load_parking_info_chunks() -> List[Dict[str, Any]]:
    ...
    if not PARKING_INFO_PATH.exists():
        return [
            {"content": "Parking facility: 24/7. Standard and premium spaces.", "metadata": {"source": "fallback"}},
            {"content": "Rates: standard $5/hour, $30/day; premium $8/hour, $45/day.", "metadata": {"source": "fallback"}},
            {"content": "Location: 123 Main Street, Downtown. Entrance on Oak Avenue.", "metadata": {"source": "fallback"}},
            {"content": "Reservation: provide nickname and preferred date. Check free spaces first.", "metadata": {"source": "fallback"}},
        ]
